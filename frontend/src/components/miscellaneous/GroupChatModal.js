import {
  ...
  ModalOverlay, useDisclosure, useToast , Box
          ...
          <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
              ...
              <ModalBody display="flex" flexDir="column" alignItems="center">
                        ...
                        <FormControl> 
                            <Input  placeholder='Add Users eg: Arun, Jatin , Raza' mb={1}
              ...
              {loading ? <div>loading</div> : (
                searchResults?.slice(0, 4).map(user => <UserListItem key={user._id} user={user}
